...
flowchart LR
    ...
    RS --> A1["Runner A"]
    RS --> A2["Runner B"]
    A1 --> LT["Pinned official Technocore v0.13.0"]
    A2 --> LT
...
- pinned official Technocore v0.13.0 on an internal-only network for authoritative acceptance;
- retained deterministic v0.7.0 behavioral fixture and v0.10.0 evidence for historical replay;
- orchestrator;
